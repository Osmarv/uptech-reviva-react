  ...
  return (
    ...
    <Section id="productDetails">
      <ProductDetailsWrapper>
        <ProductDetailsImage>
          <img
            src={process.env.PUBLIC_URL + product?.imagens[0].url}
            alt="Foto do produto "
            width="564px "
            height="593px "
          />
        ...
        <ProductDetailsSideInfos>
          <div>
            ...
            <Thumbnails>
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/images/cropped.png"}
                  alt="crooped preto "
                  width="140px "
                  height="109px "
                />
              ...
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/images/vestido_longo.png"}
              ...
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/images/listrada.png"}
                  alt="blusa listrada "
                  width="140px "
                  height="109px "
                />
              ...
              <div>
                <img
                  src={process.env.PUBLIC_URL + "/images/calca.png"}
                  alt="calça preta "
                  width="140px "
                  height="109px "
                />
